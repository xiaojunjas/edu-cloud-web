    ...
    $('table').each(function () {
        if ($(this).data('table') == 'dnd') {
            ...
            $(this).tableDnD({
                ...
                onDrop: $(this).data('ondrop') && new Function('table', 'row', $(this).data('ondrop')),
                onDragStart: $(this).data('ondragstart') && new Function('table', 'row' ,$(this).data('ondragstart')),
        ...
        config.dragHandle
            ...
            || $(table.rows).each(function() {
                ...
                if (! $(this).hasClass("nodrag")) {
                    ...
                    }).css("cursor", "default"); // Store the tableDnD object
                } else {
